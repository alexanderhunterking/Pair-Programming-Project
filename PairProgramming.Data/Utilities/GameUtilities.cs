...
namespace PairProgramming.Data.Utilities
{
    public static class GameUtilities
    {
        ...
        {
            string[] listOfStuff = File.ReadAllLines(@"C:\ElevenFiftyProjects_175\codingFoundations\dotnetProjects\assignments\consoleGame\PairProgramming.Data\PlayerItems.txt");
